...
var Terminal = (function () {
	...
	promptInput = function (terminalObj, message, PROMPT_TYPE, callback) {
		...
		if (message.length)
			terminalObj._inputPrompt.textContent = PROMPT_TYPE === PROMPT_CONFIRM ? message + ' (y/n)' : message;
		...
		inputField.onkeyup = function (e) {
			if (PROMPT_TYPE === PROMPT_CONFIRM || e.which === 13) {
				...
				if (shouldDisplayInput) terminalObj.print((message.length ? (PROMPT_TYPE === PROMPT_CONFIRM ? message + ' (y/n)' : message) : "") + inputValue)
	...
	var TerminalConstructor = function (id) {
		...
		this._inputPrompt.style.cssFloat="left";
		//this._inputPrompt.style.marginRight="1px";
